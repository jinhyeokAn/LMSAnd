...
public class ScoreAdapter extends RecyclerView.Adapter<ScoreAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder h, @SuppressLint("RecyclerView") int i) {
        h.tv_lecture_title.setText(list.get(i).getLecture_title());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_lecture_title,tv_score, detail_lecture_title, detail_teacher_name, detail_lecture_year, detail_semester, detail_score, detail_score_name;
